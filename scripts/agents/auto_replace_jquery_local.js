...
// Restrict to this module (FoundryAuras)
...
const outPath = path.join(__dirname, 'jquery_auto_replacements_local.json');
fs.writeFileSync(outPath, JSON.stringify(out, null, 2), 'utf8');
console.log('Local auto-replace complete. Changed files:', changed.length);
